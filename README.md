...
$ export GITHUB_USERNAME=AlexanderSkrebkov3
$ export GITHUB_EMAIL=79167308415@yandex.ru
...
# установка параметров протокола git
...
$ git commit -m" added sources" #Коммит с подписью " added sources"
